...
class prep_data:
    ...
    def prepare_data(self,df,tokenizer,model):
        ...
        loaded_embeddings = np.load('/Users/deekshitasavanur/Downloads/Data240_Team8/all_embeddings_skills_only.npz')
...
def main():
    ...
    encoder_model.save('/Users/deekshitasavanur/Downloads/Data240_Team8/models/skills/encoder_model.h5')
    
    # Save the decoder model
    decoder_model.save('/Users/deekshitasavanur/Downloads/Data240_Team8/models/skills/decoder_model.h5')
    
    import pickle
    
    # Assuming 'tokenizer' is your tokenizer object
    with open('/Users/deekshitasavanur/Downloads/Data240_Team8/models/skills/tokenizer.pickle', 'wb') as handle:
